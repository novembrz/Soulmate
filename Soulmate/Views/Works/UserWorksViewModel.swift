...
final class UserWorksViewModel: ObservableObject {
    ...
    var columns: [GridItem] = Array(repeating: .init(.flexible(minimum: 125, maximum: 170), spacing: 16, alignment: .top), count: 2)
    var columns2: [GridItem] = Array(repeating: .init(.adaptive(minimum: 125, maximum: 170), spacing: 16, alignment: .top), count: 2)
}
